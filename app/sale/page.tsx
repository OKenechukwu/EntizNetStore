...
import Price from "@/components/ui/Price"; // ⬅️ unified Price component (symbol + conversion)
...
export default function SalePage() {
  ...
  // ⬅️ Fetch FX rates once (client-side)
  useEffect(() => {
    let mounted = true;
    (async () => {
      try {
        // Adjust this path if your rates API differs
        // Expected shape: { base: "USD", rates: { EUR: 0.93, GBP: 0.78, ... } }
        ...
        if (mounted) setRates(null); // Price will still show symbol; no conversion
      }
    })();
    return () => {
      mounted = false;
  ...
  const loadSaleProducts = async () => {
    ...
    const demoProducts: SaleProduct[] =
      brand === "primediscreet"
        ? [
            {
              id: "1",
            ...
            },
            {
              ...
              category: "Designer Lingerie",
              brand: "Silk Dreams",
              rating: 4.7,
              review_count: 156,
              discount_percentage: 25,
              sale_end_date: "2025-01-20",
            },
            {
              id: "3",
              title: "Elite Wellness Starter Set",
              slug: "elite-wellness-starter",
              base_price: 179.99,
              compare_at_price: 229.99,
              category: "Luxury Wellness",
              brand: "Elite Wellness",
              rating: 4.6,
              review_count: 201,
              discount_percentage: 22,
              sale_end_date: "2025-01-25",
            },
            {
              id: "4",
              title: "Artisan Crystal Holiday Set",
              slug: "artisan-crystal-holiday",
              base_price: 219.99,
              ...
              sale_end_date: "2025-01-10",
              limited_stock: true,
            },
            {
              id: "5",
              title: "Luxury Couples Bundle",
              slug: "luxury-couples-bundle",
              base_price: 199.99,
              compare_at_price: 279.99,
              category: "Couples Elite",
              brand: "Intimate Elite",
              rating: 4.9,
              review_count: 76,
              discount_percentage: 29,
              sale_end_date: "2025-01-30",
            },
            {
              id: "6",
              title: "Gold Anniversary Collection",
              slug: "gold-anniversary-collection",
              base_price: 349.99,
        ...
        : [
            ...
            {
              id: "3",
              title: "Wellness Journey Kit",
              slug: "wellness-journey-kit",
              base_price: 199.99,
            ...
            {
              id: "4",
              title: "Comfort Massage Holiday Set",
              slug: "comfort-massage-holiday",
              base_price: 109.99,
            ...
            {
              id: "5",
              title: "Couples Communication Kit",
              slug: "couples-communication-kit",
              base_price: 89.99,
      ...
      switch (sortBy) {
        ...
        case "savings":
          return (
            b.compare_at_price -
            b.base_price -
            (a.compare_at_price - a.base_price)
          );
        case "price-low":
        ...
        case "ending-soon":
          return (
            new Date(a.sale_end_date).getTime() -
            new Date(b.sale_end_date).getTime()
          );
        default:
          return b.discount_percentage - a.discount_percentage;
      }
        ...
        <div className="mb-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            >
              ...
              <Price
                amountUSD={Number(product.base_price)}
            ...
            >
              ...
              <Price
                amountUSD={Number(product.compare_at_price)}
                rates={rates ?? undefined}
              />
            </span>
          </div>
          <p className="text-xs font-medium text-green-600">
            You save{" "}
            <Price
              amountUSD={Number(product.compare_at_price - product.base_price)}
              rates={rates ?? undefined}
            />
            !
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          >
            <div className="text-2xl font-bold text-red-500 mb-2">
              Up to {Math.max(...products.map((p) => p.discount_percentage))}%
              OFF
            </div>
            <p
              className="text-sm"
