...
export default function PopularPage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        // Adjust path if your endpoint differs. Expected: { base: "USD", rates: { EUR: 0.93, ... } }
  ...
  const loadPopularProducts = async () => {
    ...
    const demoProducts: PopularProduct[] =
      brand === "primediscreet"
        ? [
            {
              id: "1",
            ...
            },
            {
              ...
              slug: "handcrafted-gold-collection",
              base_price: 399.99,
    ...
    const sortedProducts = [...demoProducts].sort((a, b) => {
      switch (sortBy) {
        ...
        default: // popularity
          return (
            b.views * 0.3 + b.sales * 0.7 - (a.views * 0.3 + a.sales * 0.7)
          );
      }
    });
