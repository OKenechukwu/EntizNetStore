    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      >
        ...
        <div className="space-y-2">
          <div className="flex justify-between">
            ...
            <span style={{ color: theme.colors.text.primary }}>
              <Price amountUSD={calculateTotal.subtotal} />
            </span>
          </div>
          ...
          {product.requires_shipping && (
            <div className="flex justify-between">
              ...
              <span style={{ color: theme.colors.text.secondary }}>
                <Price amountUSD={calculateTotal.shipping} />
              </span>
            </div>
          )}
          ...
          <div className="flex justify-between">
            ...
            <span style={{ color: theme.colors.text.secondary }}>
              <Price amountUSD={calculateTotal.tax} />
            </span>
          </div>
          ...
          >
            <div className="flex justify-between font-semibold">
              ...
              <span style={{ color: theme.colors.accent }}>
                <Price amountUSD={calculateTotal.total} />
              </span>
            </div>
          </div>
        </div>
      ...
      >
        {processing ? (
          ...
          <>
            Complete Elite Purchase • <Price amountUSD={calculateTotal.total} />
          </>
        ) : (
          <>
            Complete Purchase • <Price amountUSD={calculateTotal.total} />
          </>
        )}
      </button>
      ...
      >
        🔒{" "}
        {brand === "primediscreet"
          ? "Elite-grade secure payment processing"
          : "Secure payment processing"}{" "}
        by Stripe
        <br />
        {brand === "primediscreet"
          ? "Discrete billing and premium escrow protection"
