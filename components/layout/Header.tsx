          ...
          <div className="space-y-4 px-4 py-4">
            ...
            <div className="flex flex-col gap-2">
              {[
                ...
                <Link key={link.href} href={link.href} className="flex h-12 items-center rounded-lg bg-white/5 px-4 text-sm font-medium text-foreground transition hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-secondary" onClick={() => setMobileOpen(false)}>
