...
export const translations = {
  ...
  fr: {
    ...
    quantity: "Quantité:",
    description: "Description",
    featuresSpecs: "Caractéristiques et Spécifications",
  ...
  de: {
    ...
    featuresSpecs: "Eigenschaften & Spezifikationen",
  ...
  th: {
    ...
    featuresSpecs: "คุณสมบัติและข้อมูลจำเพาะ",
  ...
  fil: {
    ...
    addedToCart: "Nailagay na sa Cart!",
    quantity: "Dami:",
    description: "Paglalarawan",
    featuresSpecs: "Mga Feature at Specification",
    keyFeatures: "Pangunahing Features:",
